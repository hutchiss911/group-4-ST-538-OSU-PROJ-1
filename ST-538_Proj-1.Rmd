...
```{r, message=FALSE, echo=FALSE, results='hide', warning=FALSE, fig.show='center'}
...
```
```{r,  error=TRUE, collapse=TRUE, warning=FALSE, echo=FALSE, results='hide', message=FALSE}
#Multi-colinearlity
options(warn=-1)
vif(model_5)
options(warn=0)
